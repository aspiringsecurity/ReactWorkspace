...
const CardButtons = props => {
  return (
    <View style={style.buttonContainer}>
      <TouchableHighlight style={[style.cardButton, style.topLeft]} onPress={props.flipTopRight}>
        <MCIcon
      ...
      <TouchableHighlight style={[style.cardButton, style.bottomRight]} onPress={props.flip}>
        <FIcon
          name="refresh-ccw"
          size={18}
